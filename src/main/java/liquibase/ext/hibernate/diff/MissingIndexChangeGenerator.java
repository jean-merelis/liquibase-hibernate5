...
public class MissingIndexChangeGenerator extends liquibase.diff.output.changelog.core.MissingIndexChangeGenerator {
    ...
    public Change[] fixMissing(DatabaseObject missingObject, DiffOutputControl control, Database referenceDatabase, Database comparisonDatabase, ChangeGeneratorChain chain) {
        ...
        if (referenceDatabase instanceof HibernateDatabase || comparisonDatabase instanceof HibernateDatabase) {//original
//        if (comparisonDatabase instanceof HibernateDatabase) {
            return null;
        } else {
